    ...
    def validate_user_args(args: list) -> (bool, str):
        try:
            ...
            _encoded_args = ":".join([
                ...
                "Z2l0X3Byb3ZpZGVy", "c2tpcF9rZXlz", "b3BlbmFpLmtleQ==",
                "QU5BTFlUSUNTX0ZPTERFUg==", "dXJp", "YXBwX2lk", "d2ViaG9va19zZWNyZXQ=",
                "YmVhcmVyX3Rva2Vu", "UEVSU09OQUxfQUNDRVNTX1RPS0VO",
                "b3ZlcnJpZGVfZGVwbG95bWVudF90eXBl", "cHJpdmF0ZV9rZXk=",
                "bG9jYWxfY2FjaGVfcGF0aA==", "ZW5hYmxlX2xvY2FsX2NhY2hl",
                "amlyYV9iYXNlX3VybA==", "YXBpX2Jhc2U=", "YXBpX3R5cGU=",
                "YXBpX3ZlcnNpb24=", "c2tpcF9rZXlz",
                "ZW5hYmxlX2NvbW1hbmRfbW9kZWxfb3ZlcnJpZGVz",
            ...
            for arg in args:
                ...
                if arg.startswith('--'):
                    arg_word = arg.lower()
                    # Replace double underscores with dots, e.g. --openai__key -> --openai.key.
